...
modelo.4 <- lm(mpg ~ wt + disp + cyl + am, data=datos_entrenamiento) 
...
datos <- data_frame(ventas, tv, radio, online)
...
modelo.ventas1 = lm(ventas ~ tv + radio + online, data=datos)
summary(modelo.ventas1)


predict(modelo.ventas1)


modelo.ventas2 = lm(ventas ~   online, data=datos)
summary(modelo.ventas2)


modelo.ventas3 = lm(ventas ~  radio + online, data=datos)
summary(modelo.ventas3)
